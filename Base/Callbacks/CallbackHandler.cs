...
namespace PVZEngine.Callbacks
{
    ...
    internal class CallbackHandlerFiltered<TArgs, TResult, TFilter> : CallbackHandlerBase<TriggerFiltered<TArgs, TResult, TFilter>>
    {
        ...
        private bool IsFilterMatched(TriggerFiltered<TArgs, TResult, TFilter> trigger, TFilter? callbackFilter)
        {
            ...
            if (triggerFilter is null || callbackFilter is null)
                return true;
            return EqualityComparer<TFilter>.Default.Equals(triggerFilter, callbackFilter);
        }
    }
    internal class CallbackHandlerFiltered<TArgs, TFilter> : CallbackHandlerBase<TriggerFiltered<TArgs, TFilter>>
    {
        ...
        private bool IsFilterMatched(TriggerFiltered<TArgs, TFilter> trigger, TFilter? callbackFilter)
        {
            if (!trigger.UseFilter)
                return true;
            var triggerFilter = trigger.Filter;
