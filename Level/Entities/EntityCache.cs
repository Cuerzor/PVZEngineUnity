...
namespace PVZEngine.Entities
{
    public class EntityCache
    {
        public void UpdateAll(Entity entity)
        {
            ...
            BoundsRotation = entity.GetBoundsRotation();
        ...
        public void UpdateProperty(Entity entity, IPropertyKey name, object? beforeValue, object? afterValue)
        {
            ...
            else if (EngineEntityProps.BOUNDS_ROTATION.Equals(name))
            {
                BoundsRotation = afterValue.ToGeneric<Vector3>();
                entity.UpdateCollisionSize();
            }
            else if (EngineEntityProps.BOUNDS_OFFSET.Equals(name))
            {
                BoundsOffset = afterValue.ToGeneric<Vector3>();
                entity.UpdateCollisionSize();
            }
        ...
        public Vector3 BoundsRotation { get; private set; }
