...
namespace PVZEngine.Entities
{
    public abstract class EntityDefinition : Definition, ICachedDefinition
    {
        ...
        void ICachedDefinition.CacheContents(IGameContent content)
        {
            ...
            var auras = new List<AuraEffectDefinition>();
            foreach (var behaviourID in behaviours)
            {
                ...
                modifiers.AddRange(behaviour.GetModifiers());
                auras.AddRange(behaviour.GetAuras());
            }
            modifierCaches = modifiers.ToArray();
            auraCaches = auras.ToArray();
        }
        void ICachedDefinition.ClearCaches()
        {
            behaviourCaches.Clear();
            modifierCaches = Array.Empty<PropertyModifier>();
            auraCaches = Array.Empty<AuraEffectDefinition>();
        }
        ...
        private PropertyModifier[] modifierCaches = Array.Empty<PropertyModifier>();
        private AuraEffectDefinition[] auraCaches = Array.Empty<AuraEffectDefinition>();
    }
}
