...
namespace PVZEngine.Level
{
    public partial class LevelEngine
    {
        ...
        #region 序列化
        private void WriteGridsToSerializable(SerializableLevel seri)
        {
            seri.grids = new SerializableGrid[grids.Length];
            for (int i = 0; i < seri.grids.Length; i++)
            {
                seri.grids[i] = grids[i].ToSerializable();
            }
        }
